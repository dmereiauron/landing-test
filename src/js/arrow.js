...
import ArrowBottom from '../public/images/arrow_bottom.png'
...
window.Arrow = (function (window, document, undefined) {
  ...
  function _applyStyleModern(node) {
    ...
    node.style.backgroundImage = `url(${ArrowBottom} )`
  ...
  function _applyStyleIE8(node) {
    ...
    var opacity = 'progid:DXImageTransform.Microsoft.Alpha(opacity=0) ',
      imgSrc =
        'progid:DXImageTransform.Microsoft.AlphaImageLoader(src=`${ArrowBottom}`, sizingMethod="scale") ',
      rotation =
  ...
  function _applyStyleMoz(node) {
    ...
    node.style.backgroundImage = `url(${ArrowTop} )`
  }
